		...
		<div class="flex gap-8 flex-col md:flex-row items-center">
			...
			<div>
				<p class="text-white text-lg px-10 md:px-0 font-light md:mr-32 mt-2" style="font-family: Saira Condensed, sans-serif;">
					...
					perspiciatis nam vero vel explicabo dignissimos? Aspernatur dolor voluptas ut ab. Sit hic harum 
					cupiditate quis mollitia quas in nam, reprehenderit velit ipsum fugiat.
				</p>
			</div>
        </div>
	</section>
...
.about-bg {
    ...
    rgba(56, 2, 209, 0.86) 10%, 
    rgba(126, 0, 0, 0.86) 40%, 
    rgba(126, 0, 0, 0.86) 40%, 
    rgba(56, 2, 209, 0.86) 90%);
	left:0;right:0;bottom:0;
}

.leaderboard-bg {
	background: linear-gradient(180deg, rgba(0, 0, 0, 0.86) 40%, rgba(153, 0, 0, 0.86) 80%);
}
...
.stream-bg {
	background: radial-gradient(50% 50% at 50% 50%, rgba(153, 1, 1, 0.86) 41.5%, rgba(43, 2, 209, 0.86) 100%);
}
